...
public class FilterSqlConsumer {
    public static void main(String[] args) throws MQClientException {
        ...
        // *表示不过滤 所有消息都消费
        consumer.subscribe("Filter", MessageSelector.bySql("Tags is not null and tags = ('TagA','TagC') and (baili is not null and baili between 0 and 3 )"));
        //并发消费
